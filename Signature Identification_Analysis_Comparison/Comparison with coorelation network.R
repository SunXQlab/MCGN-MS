...
ks.test(AUC_OS, AUC_OS_PCCNet, alternative = "less", exact = T)   # not less than
ks.test(AUC_3Y, AUC_3Y_PCCNet, alternative = "less", exact = T) 
ks.test(AUC_5Y, AUC_5Y_PCCNet, alternative = "less", exact = T) 
